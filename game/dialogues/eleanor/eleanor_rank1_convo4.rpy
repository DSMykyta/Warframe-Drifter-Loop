...
init python:
    DIALOGUE_ENTRIES.append({
        ...
        "chance": 100,
        "titles": [
            ("Привіт. Хотів зайти, перевірити.", "eleanor_r1c4_validate"),
            ("Щось не так? Ти якась задумлива.", "eleanor_r1c4_empathize"),
            ("Елеонор, можу чимось допомогти?", "eleanor_r1c4_help"),
        ],
    })
