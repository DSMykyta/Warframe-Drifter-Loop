...
registerScript("stub_el_patterns", [
  ...
  { type: "telepathy", text: "Завжди. Все навколо — патерни." },
  { type: "telepathy", text: "Летті п'є каву о сьомій. Амір вмикає музику о восьмій. Квінсі жартує о дев'ятій." },
  { type: "telepathy", text: "А ти приходиш до мене, коли не знаєш куди себе подіти." },
  { type: "telepathy", text: "Це теж патерн." },
  { type: "end", text: "" }
]);
